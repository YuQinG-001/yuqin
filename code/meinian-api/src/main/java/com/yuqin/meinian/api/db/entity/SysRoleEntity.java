...
public class SysRoleEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getRoleId() == null ? other.getRoleId() == null : this.getRoleId().equals(other.getRoleId()))
                ...
                && (this.getPermissionIds() == null ? other.getPermissionIds() == null
                                                    : this.getPermissionIds().equals(other.getPermissionIds()))
                && (this.getDefaultPermissions() == null ? other.getDefaultPermissions() == null
                                                         : this.getDefaultPermissions()
                            .equals(other.getDefaultPermissions()))
                && (this.getIsSystem() == null ? other.getIsSystem() == null
