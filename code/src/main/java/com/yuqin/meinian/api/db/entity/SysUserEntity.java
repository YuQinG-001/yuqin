...
public class SysUserEntity implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getUserId() == null ? other.getUserId() == null : this.getUserId().equals(other.getUserId()))
                ...
                && (this.getRoleIds() == null ? other.getRoleIds() == null
                                              : this.getRoleIds().equals(other.getRoleIds()))
                && (this.getIsSuperAdmin() == null ? other.getIsSuperAdmin() == null
                                                   : this.getIsSuperAdmin().equals(other.getIsSuperAdmin()))
